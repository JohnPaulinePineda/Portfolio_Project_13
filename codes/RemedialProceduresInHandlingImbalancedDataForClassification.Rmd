---
title: "Data Preprocessing : Remedial Procedures in Handling Imbalanced Data for Classification"
...
|
| **[A]** The class imbalance treatment methods which demonstrated the best and most consistent AUROC metrics using the **Bagged Trees** model are as follows:
|      **[A.1]** **RU-OUT: Random Undersampling - Outside Resampling**
|             **[A.1.1]** Test AUROC = 0.90909, Cross-Validation AUROC = 0.82000
|      **[A.2]** **RU-IN:  Random Undersampling - Inside Resampling**
|             **[A.2.1]** Test AUROC = 0.88744, Cross-Validation AUROC = 0.79089
|      **[A.3]** **ROSE-OUT: Random Oversampling Examples - Outside Resampling**
|             **[A.3.1]** Test AUROC = 0.80087, Cross-Validation AUROC = 0.86373
|
|
...
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_13/images/Project13_Summary.png)
|
# **3. References**
|
